...
import { Check, X, Loader2, Plug, Link, Unlink, Server } from 'lucide-vue-next'
      ...
      <div class="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-4">
        ...
        <div class="bg-bg-card border border-border rounded-xl p-6 flex flex-col gap-4">
          ...
          <div
            ...
            :class="providers?.google?.configured ? 'bg-emerald-500/10 text-success' : 'bg-red-500/10 text-danger'"
          >
        ...
        <div class="bg-bg-card border border-border rounded-xl p-6 flex flex-col gap-4">
          ...
          <div
            class="flex items-center gap-1.5 text-[13px] font-medium py-2 px-3 rounded-lg"
            :class="providers?.microsoft?.configured ? 'bg-emerald-500/10 text-success' : 'bg-red-500/10 text-danger'"
          >
